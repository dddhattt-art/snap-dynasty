  ...
  return (
    <div className="dash-wrapper">
      ...
      <main className="content">
        ...
        {tab === 'draft-board'  && <DraftBoard players={players} leagueId={leagueId!} teamCount={league?.settings?.num_teams ?? 12} isLoading={playersLoading} salaries={salaries} cap={cap} rosters={r} userMap={userMap} />}
        </div>
        </div>
      </main>
      </div>
